...
фильтрует корзину с товарами `filterOrderedProducts, принимает еденичный товар`, `addToBasket, принимает еденичный товар` позволяет добавить продукт в корзину,
